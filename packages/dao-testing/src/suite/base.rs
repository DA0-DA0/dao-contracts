...
impl DaoTestingSuiteBase {
    pub fn base() -> Self {
        ...
        let filter_id = app.store_code(cw_filter_contract());
        let protobuf_registry_id = app.store_code(cw_protobuf_registry_contract());
