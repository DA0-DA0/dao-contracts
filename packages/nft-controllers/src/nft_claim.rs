...
mod test {
    ...
    use super::*;
    const TEST_BAYC_TOKEN_ID: &str = "cosmwasm1dd4y2v9eezmztw05spxfp8lpdtgc2wq7yk5jr5q9d73yt80kxmnqlfy005";
    const TEST_CRYPTO_PUNKS_TOKEN_ID: &str = "cosmwasm1jmfdj63g8vfmzxnlrkw8atpcmc8tg7kgm2gk467j3wjesl09qkxq084twu";
    ...
    fn check_create_claim_updates_map() {
        ...
        let saved_claims = claims
            .0
            .prefix(&Addr::unchecked("cosmwasm15fvnexrvsm9ryw3nn4mcrnqyhvhazkkr48xnwtlegjz2uaxmhg0sjzfhfz"))
        ...
        claims
            .create_nft_claims(
                deps.as_mut().storage,
                &Addr::unchecked("cosmwasm1cq2j7y4utseeatek2alfy5ttaphjrtdxqqz0sn820v9jupy0seuqmh8c9s"),
        ...
        let saved_claims_addr2 = claims
            .0
            .prefix(&Addr::unchecked("cosmwasm1cq2j7y4utseeatek2alfy5ttaphjrtdxqqz0sn820v9jupy0seuqmh8c9s"))
            .range(deps.as_mut().storage, None, None, Order::Ascending)
            .collect::<StdResult<Vec<_>>>()
            .unwrap();
        assert_eq!(saved_claims.len(), 2);
    ...
    fn test_query_claims_returns_correct_claims() {
        ...
        let queried_claims = claims
            .query_claims(deps.as_ref(), &Addr::unchecked("cosmwasm15fvnexrvsm9ryw3nn4mcrnqyhvhazkkr48xnwtlegjz2uaxmhg0sjzfhfz"), None, None)
            .unwrap();
        let saved_claims = claims
            .0
            .prefix(&Addr::unchecked("cosmwasm15fvnexrvsm9ryw3nn4mcrnqyhvhazkkr48xnwtlegjz2uaxmhg0sjzfhfz"))
    ...
    fn test_query_claims_returns_correct_claims_paginated() {
        ...
        let queried_claims = claims
            .query_claims(deps.as_ref(), &Addr::unchecked("cosmwasm15fvnexrvsm9ryw3nn4mcrnqyhvhazkkr48xnwtlegjz2uaxmhg0sjzfhfz"), None, Some(1))
            .unwrap();
        assert_eq!(
            queried_claims,
            vec![NftClaim::new(
    ...
    fn test_query_claims_returns_empty_for_non_existent_user() {
        ...
        let queried_claims = claims
            .query_claims(deps.as_ref(), &Addr::unchecked("cosmwasm1cq2j7y4utseeatek2alfy5ttaphjrtdxqqz0sn820v9jupy0seuqmh8c9s"), None, None)
            .unwrap();
