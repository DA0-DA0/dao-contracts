...
use dao_core::query::{GetItemResponse, ProposalModuleCountResponse};
...
fn test_v1_v2_full_migration() {
    ...
    let core_code = app.store_code(v1_dao_core_contract());
    ...
    let v2_core_code = app.store_code(dao_core_contract());
    ...
    let module_counts: ProposalModuleCountResponse = app
        .wrap()
        .query_wasm_smart(&core, &dao_core::msg::QueryMsg::ProposalModuleCount {})
        .unwrap();
    assert_eq!(
        module_counts,
    ...
    make_proposal(
        ...
        vec![WasmMsg::Execute {
            contract_addr: core.to_string(),
            msg: to_binary(&dao_core::msg::ExecuteMsg::UpdateCw20List {
                to_add: vec![],
    ...
    let tokens: Vec<dao_core::query::Cw20BalanceResponse> = app
        .wrap()
        .query_wasm_smart(
            &core,
            &dao_core::msg::QueryMsg::Cw20Balances {
                start_after: None,
                limit: None,
            },
        )
