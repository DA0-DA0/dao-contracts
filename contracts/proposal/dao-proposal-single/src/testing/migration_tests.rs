...
//             core_code,
//             sender.clone(),
//             &dao_dao_core_v2::msg::InstantiateMsg {
...
//                 voting_module_instantiate_info: dao_dao_core_v2::msg::ModuleInstantiateInfo {
//                     code_id: voting_code,
...
//                     })
//                     .unwrap(),
//                     admin: dao_dao_core_v2::msg::Admin::CoreContract {},
//                     label: "voting".to_string(),
//                 },
//                 proposal_modules_instantiate_info: vec![
//                     dao_dao_core_v2::msg::ModuleInstantiateInfo {
//                         code_id: proposal_code,
//                         msg: to_binary(&dao_proposal_single_v2::msg::InstantiateMsg {
//                             threshold: voting_v2::Threshold::AbsolutePercentage {
//                                 percentage: voting_v2::PercentageThreshold::Majority {},
//                             },
//                             max_voting_period: cw_utils_v2::Duration::Height(6),
...
//                     },
//                 ],
//                 initial_items: Some(vec![dao_dao_core_v2::msg::InitialItem {
//                     key: "key".to_string(),
...
//         let voting: Addr = app
//             .wrap()
//             .query_wasm_smart(&core, &dao_dao_core_v2::msg::QueryMsg::VotingModule {})
//             .unwrap();
...
//             .query_wasm_smart(
//                 &core,
//                 &dao_dao_core_v2::msg::QueryMsg::ProposalModules {
//                     start_at: None,
//                     limit: None,
//                 },
//             )
...
//                 contract_addr: core.to_string(),
//                 msg: to_binary(&dao_dao_core_v2::msg::ExecuteMsg::UpdateCw20List {
...
//     )
//     .unwrap();
//     let tokens: Vec<dao_dao_core_v2::query::Cw20BalanceResponse> = app
//         .wrap()
//         .query_wasm_smart(
//             &core,
//             &dao_dao_core_v2::msg::QueryMsg::Cw20Balances {
//                 start_at: None,
//                 limit: None,
//             },
//         )
...
//     assert_eq!(
//         tokens,
//         vec![dao_dao_core_v2::query::Cw20BalanceResponse {
//             addr: token.clone(),
...
//         proposal: dao_proposal_single_v2::proposal::Proposal { status, .. },
//         ..
//     } = app
//         .wrap()
//         .query_wasm_smart(
...
//         )
//         .unwrap();
//     assert_eq!(status, voting_v2::Status::Passed);
...
//                     msg: to_binary(&dao_interface::msg::MigrateMsg::FromV2 {
...
//                     msg: to_binary(&crate::msg::MigrateMsg::FromV2 {
