...
pub struct InstantiateMsg {
    ...
    /// If set to true voters will be allowed to leave comments along
    /// with their votes.
...
pub enum ExecuteMsg {
    ...
    Vote {
        ...
        vote: voting::Vote,
        /// An optional comment about why the vote was cast.
    ...
    UpdateConfig {
        ...
        /// If comments should be enabled. Turning this off will mean
        /// no comments can be made on proposals. This is set globaly
        /// and not on a per proposal basis so disabling / enabling
        /// this will also disable / enable comments on outstanding
        /// proposals.
