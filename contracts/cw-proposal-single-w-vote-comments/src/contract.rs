...
const CONTRACT_NAME: &str = "crates.io:cw-proposal-single-w-vote-comments";
...
pub fn instantiate(
    ...
    let config = Config {
        ...
        enable_comments: msg.enable_comments,
    };
...
pub fn execute(
    ...
    match msg {
        ...
        ExecuteMsg::Vote {
            ...
            vote,
            comment,
        } => execute_vote(deps, env, info, proposal_id, vote, comment),
...
pub fn execute_vote(
    ...
    if comment.is_some() && !config.enable_comments {
        return Err(ContractError::CommentsDisabled {});
    }
