...
pub struct Config {
    ...
    /// If set to true voters will be able to leave comments alongside
    /// their votes.
    ///
    /// NOTE: this is set globally and not on a per proposal
    /// basis. Frontends should likely hide all comments on proposals
    /// if this is disabled. Having this set globally instead of on a
    /// per-proposal basis makes small amounts of moderation possible.
...
pub struct Ballot {
    ...
    /// The position.
    pub vote: Vote,
    /// A comment about why this vote was cast.
