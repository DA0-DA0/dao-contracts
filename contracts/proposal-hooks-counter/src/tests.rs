...
use voting::{PercentageThreshold, SingleChoiceVote, Threshold};

use crate::msg::{CountResponse, InstantiateMsg, QueryMsg};
use cw_proposal::state::Config;
...
fn single_govmod_contract() -> Box<dyn Contract<Empty>> {
    let contract = ContractWrapper::new(
        cw_proposal::contract::execute,
        cw_proposal::contract::instantiate,
        cw_proposal::contract::query,
    )
    .with_reply(cw_proposal::contract::reply);
    Box::new(contract)
}
...
fn instantiate_with_default_governance(
    app: &mut App,
    code_id: u64,
    msg: cw_proposal::msg::InstantiateMsg,
...
//     let instantiate = cw_proposal::msg::InstantiateMsg {
//         threshold,
//         max_voting_period,
...
//         .query_wasm_smart(
//             govmod_single.clone(),
//             &cw_proposal::msg::QueryMsg::Config {},
//         )
//         .unwrap();
...
//         dao.clone(),
//         govmod_single.clone(),
//         &cw_proposal::msg::ExecuteMsg::AddProposalHook {
...
//         dao.clone(),
//         govmod_single.clone(),
//         &cw_proposal::msg::ExecuteMsg::AddVoteHook {
//             address: counters.to_string(),
//         },
//         &[],
//     )
...
//         .query_wasm_smart(
//             govmod_single.clone(),
//             &cw_proposal::msg::QueryMsg::ProposalHooks {},
//         )
//         .unwrap();
...
//         .query_wasm_smart(
//             govmod_single.clone(),
//             &cw_proposal::msg::QueryMsg::VoteHooks {},
//         )
//         .unwrap();
//     assert_eq!(hooks.hooks.len(), 1);
...
//         Addr::unchecked(CREATOR_ADDR),
//         govmod_single.clone(),
//         &cw_proposal::msg::ExecuteMsg::Propose {
...
//         Addr::unchecked(CREATOR_ADDR),
//         govmod_single.clone(),
//         &cw_proposal::msg::ExecuteMsg::Vote {
//             proposal_id: 1,
//             vote: SingleChoiceVote::Yes,
//         },
//         &[],
//     )
//     .unwrap();
...
//             dao.clone(),
//             govmod_single.clone(),
//             &cw_proposal::msg::ExecuteMsg::RemoveProposalHook {
//                 address: failing_counters.to_string(),
//             },
//             &[],
//         )
...
//             dao,
//             govmod_single.clone(),
//             &cw_proposal::msg::ExecuteMsg::RemoveVoteHook {
//                 address: failing_counters.to_string(),
//             },
//             &[],
//         )
...
//     let hooks: HooksResponse = app
//         .wrap()
//         .query_wasm_smart(govmod_single, &cw_proposal::msg::QueryMsg::VoteHooks {})
//         .unwrap();
//     assert_eq!(hooks.hooks.len(), 1);
// }
