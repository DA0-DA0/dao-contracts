...
use cw20_gov::msg::{VotingPowerAtHeightResponse, QueryMsg as Cw20GovQueryMsg};
...
pub fn execute_vote(
    ...
    let vote_power = get_voting_power_at_height(deps.as_ref(), info.sender.clone(), prop.start_height)?;
