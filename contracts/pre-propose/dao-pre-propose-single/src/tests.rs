use cosmwasm_std::{
    coins, from_json, to_json_binary, Addr, Coin, Empty, Uint128,
};
...
use dao_testing::{
    contracts::{
        cw20_base_contract, dao_pre_propose_single_contract,
...
fn test_hook_management() {
    ...
    assert_eq!(
        hooks,
        vec!["cosmwasm18lzveln5tpcw9sxenaclxrlsv4kgmmw5rnqa057nw6cdhe59uteszh007r".to_string()]
    )
}
