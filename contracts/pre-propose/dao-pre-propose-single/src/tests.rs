...
// v241 imports gated off — see the `test_migrate_from_v241` cfg guards.
#[cfg(any())]
...
// v2.4.1 migration test imports — gated off; see `test_migrate_from_v241`.
#[cfg(any())]
...
fn test_no_deposit_required_members_submission() {
    ...
    let id = make_proposal(&mut app, pre_propose, proposal_single.clone(), "cosmwasm1nq9dshj4pugmaas4qcqwslmcj2x7s3gy3fkcr0as0hs88spd528qgturlg", &[]);
    let new_status = vote(&mut app, proposal_single, "cosmwasm1nq9dshj4pugmaas4qcqwslmcj2x7s3gy3fkcr0as0hs88spd528qgturlg", id, Vote::Yes);
    assert_eq!(Status::Passed, new_status)
}
...
fn test_anyone_denylist() {
    ...
    make_proposal(&mut app, pre_propose, proposal_single.clone(), "cosmwasm1nq9dshj4pugmaas4qcqwslmcj2x7s3gy3fkcr0as0hs88spd528qgturlg", &[]);
}
