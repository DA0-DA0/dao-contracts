...
use cwd_voting_staking_denom_staked::msg::{ExecuteMsg, InstantiateMsg, MigrateMsg, QueryMsg};
...
fn main() {
    ...
    export_schema_with_title(&schema_for!(Addr), &out_dir, "StakingModuleResponse");
}
