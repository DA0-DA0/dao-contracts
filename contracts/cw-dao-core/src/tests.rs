...
fn sudo_proposal_contract() -> Box<dyn Contract<Empty>> {
    let contract = ContractWrapper::new(
        cw_dao_proposal_sudo::contract::execute,
        cw_dao_proposal_sudo::contract::instantiate,
        cw_dao_proposal_sudo::contract::query,
    );
    Box::new(contract)
}
...
fn test_update_config() {
    ...
    let govmod_instantiate = cw_dao_proposal_sudo::msg::InstantiateMsg {
    ...
    app.execute_contract(
        ...
        &cw_dao_proposal_sudo::msg::ExecuteMsg::Execute {
...
fn do_standard_instantiate(auto_add: bool, admin: Option<String>) -> (Addr, App) {
    ...
    let voting_instantiate = cw_dao_voting_cw20_balance::msg::InstantiateMsg {
