...
use cw_dao_voting::deposit::{
    get_deposit_msg, get_return_deposit_msg, CheckedDepositInfo, DepositInfo,
};
...
pub fn execute_propose(
    ...
    let voting_module: Addr = deps.querier.query_wasm_smart(
        config.dao.clone(),
        &cw_dao_core::msg::QueryMsg::VotingModule {},
    )?;
    ...
    let active_resp: IsActiveResponse = deps
        ...
        .query_wasm_smart(
            voting_module,
            &cw_dao_core_interface::voting::VotingModuleQuery::IsActive {},
        )
    ...
    let response = {
        if !prop.msgs.is_empty() {
            let execute_message = WasmMsg::Execute {
                ...
                msg: to_binary(&cw_dao_core::msg::ExecuteMsg::ExecuteProposalHook {
                    msgs: prop.msgs,
                })?,
                funds: vec![],
            };
...
pub fn query_info(deps: Deps) -> StdResult<Binary> {
    ...
    to_binary(&cw_dao_core_interface::voting::InfoResponse { info })
}
