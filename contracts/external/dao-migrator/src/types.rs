...
impl V1CodeIds {
    pub fn to(self) -> dao_core::migrate_msg::V1CodeIds {
        dao_core::migrate_msg::V1CodeIds {
...
impl V2CodeIds {
    pub fn to(self) -> dao_core::migrate_msg::V2CodeIds {
        dao_core::migrate_msg::V2CodeIds {
            proposal_single: self.proposal_single,
            cw4_voting: self.cw4_voting,
            cw20_stake: self.cw20_stake,
            cw20_staked_balances_voting: self.cw20_staked_balances_voting,
