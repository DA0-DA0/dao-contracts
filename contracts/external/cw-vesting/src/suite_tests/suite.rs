    ...
    fn default() -> Self {
        ...
        Self {
            instantiate: InstantiateMsg {
                ...
                recipient: "cosmwasm1vewsdxxmeraett7ztsaym88jsrv85kzm0xvjg09xqz8aqvjcja0syapxq9".to_string(),
...
impl SuiteBuilder {
    pub fn build(self) -> Suite {
        let mut app = App::new(|router, api, storage| {
            router
                ...
                .add_validator(
                    ...
                    &mock_env().block,
                    Validator {
                        address: "cosmwasm1lq40xgtqh3f3zt9prz4m74l6dlk506us9ydp68vj7su2utkhfmmqgusez5".to_string(),
            ...
            router
                ...
                .add_validator(
                    ...
                    &mock_env().block,
                    Validator {
                        address: "cosmwasm18y3y37sqnrwv9klx58276jtvmf9ymtj8p7qsslsrmj8auq6u2ulselj2ts".to_string(),
                        commission: Decimal::zero(), // zero percent comission to keep math simple.
                        max_commission: Decimal::percent(10),
                        max_change_rate: Decimal::percent(2),
                    },
        ...
        let funds = if let cw_denom::UncheckedDenom::Native(ref denom) = self.instantiate.denom {
            ...
            app.sudo(
                BankSudo::Mint {
                    to_address: "cosmwasm1fsgzj6t7udv8zhf6zj32mkqhcjcpv52yph5qsdcl0qt94jgdckqs2g053y".to_string(),
                    amount: funds.clone(),
                }
                .into(),
            )
