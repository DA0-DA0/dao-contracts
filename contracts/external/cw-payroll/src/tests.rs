...
use cosmwasm_std::{
    coin, coins, to_binary, Addr, Coin, CosmosMsg, Decimal, DistributionMsg, Empty, StakingMsg,
    Uint128, Validator,
};
...
pub fn setup_app() -> App {
    // //  Sadly can't use multi-test for staking related tests.
    // //  Blocker: https://github.com/CosmWasm/cw-multi-test/issues/20
    ...
    //             storage,
    //             StakingInfo {
    //                 // Note, we set this to something different than the native denom
    //                 // Multitest does not support SetWithdrawAddress yet
