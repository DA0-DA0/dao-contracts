...
pub fn execute_update_owner(
    ...
    Ok(Response::default()
        .add_attribute("owner", none_or(ownership.owner))
        .add_attribute("pending_owner", none_or(ownership.pending_owner))
        .add_attribute("pending_expiry", none_or(ownership.pending_expiry)))
}
