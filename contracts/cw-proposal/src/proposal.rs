use cosmwasm_std::{
    to_binary, Addr, BlockInfo, CosmosMsg, Decimal, Empty, Response, StdResult, Storage, Uint128,
    WasmMsg,
};
...
use voting::{
    compare_vote_count, PercentageThreshold, SingleChoiceVoteCounts, Status, Threshold, VoteCmp,
    VoteCounts,
};

use crate::{
    query::ProposalResponse,
    state::{CheckedDepositInfo, ProposalType, PROPOSAL_COUNT},
};
...
pub struct MultipleChoice {
    ...
    pub winning_choice: Option<SingleChoice>,
}

impl Choices {
    /// Called when proposal has passed. Returns single choice, or winning choice
    /// out of multiple choices.
    pub fn get_winning_choice(&self) -> Option<SingleChoice> {
        match self {
            Choices::Single(c) => todo!(),
            Choices::Multiple(c) => todo!(),
        }
    }
}
...
//         };
//         let votes = SingleChoiceVoteCounts {
//             yes: Uint128::new(7),
//             no: Uint128::new(4),
...
//         let passing = SingleChoiceVoteCounts {
//             yes: Uint128::new(7),
//             no: Uint128::new(3),
//             abstain: Uint128::new(2),
//         };
//         // abstain votes are not counted for threshold => yes / (yes + no + veto)
//         let passes_ignoring_abstain = SingleChoiceVoteCounts {
//             yes: Uint128::new(6),
//             no: Uint128::new(6),
//             abstain: Uint128::new(5),
//         };
//         // fails any way you look at it
//         let failing = SingleChoiceVoteCounts {
//             yes: Uint128::new(6),
//             no: Uint128::new(7),
//             abstain: Uint128::new(2),
//         };
...
//         };
//         // all non-yes votes are counted for quorum
//         let rejecting = SingleChoiceVoteCounts {
//             yes: Uint128::new(3),
//             no: Uint128::new(8),
//             abstain: Uint128::new(2),
//         };
//         // abstain votes are not counted for threshold => yes / (yes + no)
//         let rejected_ignoring_abstain = SingleChoiceVoteCounts {
//             yes: Uint128::new(4),
//             no: Uint128::new(8),
//             abstain: Uint128::new(5),
//         };
...
//         // expired or not.
//         let missing_voters = SingleChoiceVoteCounts {
//             yes: Uint128::new(9),
//             no: Uint128::new(1),
...
//         let wait_til_expired = SingleChoiceVoteCounts {
//             yes: Uint128::new(8),
//             no: Uint128::new(4),
//             abstain: Uint128::new(0),
//         };
...
//         let passes_early = SingleChoiceVoteCounts {
//             yes: Uint128::new(9),
//             no: Uint128::new(3),
//             abstain: Uint128::new(0),
//         };
