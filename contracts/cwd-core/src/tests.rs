...
fn sudo_proposal_contract() -> Box<dyn Contract<Empty>> {
    let contract = ContractWrapper::new(
        cwd_proposal_sudo::contract::execute,
        cwd_proposal_sudo::contract::instantiate,
        cwd_proposal_sudo::contract::query,
    );
    Box::new(contract)
}
...
fn test_update_config() {
    ...
    let govmod_instantiate = cwd_proposal_sudo::msg::InstantiateMsg {
    ...
    app.execute_contract(
        ...
        &cwd_proposal_sudo::msg::ExecuteMsg::Execute {
...
fn do_standard_instantiate(auto_add: bool, admin: Option<String>) -> (Addr, App) {
    ...
    let voting_instantiate = cwd_voting_cw20_balance::msg::InstantiateMsg {
...
fn test_migrate_from_beta() {
    ...
    let proposal_instantiate = cwd_proposal_sudo::msg::InstantiateMsg {
        root: CREATOR_ADDR.to_string(),
    };
    let voting_instantiate = cwd_voting_cw20_balance::msg::InstantiateMsg {
        token_info: cwd_voting_cw20_balance::msg::TokenInfo::New {
