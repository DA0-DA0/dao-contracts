...
export interface CwDaoCoreReadOnlyInterface {
...
export class CwDaoCoreQueryClient implements CwDaoCoreReadOnlyInterface {
...
export interface CwDaoCoreInterface extends CwDaoCoreReadOnlyInterface {
  contractAddress: string;
  sender: string;
  executeAdminMsgs: ({
    msgs
...
export class CwDaoCoreClient extends CwDaoCoreQueryClient implements CwDaoCoreInterface {
